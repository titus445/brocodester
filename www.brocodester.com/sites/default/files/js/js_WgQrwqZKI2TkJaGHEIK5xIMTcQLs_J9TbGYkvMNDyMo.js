...
jQuery(document).ready(function(e) {
    var o = e('#pre-header').outerHeight() || 0,
        a = e('#header-top').outerHeight() || 0,
        d = e('#header').outerHeight() || 0;
    e(window).on('load', function(d) {
        if ((e(window).width() > 767)) {
            e('body').addClass('fixed-header-enabled')
        } else {
            e('body').removeClass('fixed-header-enabled')
        }
    });
    ...
    e(window).scroll(function() {
        if ((e(this).scrollTop() > o + a) && (e(window).width() > 767)) {
            e('body').addClass('onscroll');
            if (e('#toolbar-administration').length > 0) {
                var i = e('body').css('paddingTop');
                e('#header').css('top', i)
            };
            if (e('#page-intro').length > 0) {
                e('#page-intro').css('paddingTop', (d) + 'px')
            } else {
                e('#page').css('paddingTop', (d) + 'px')
            }
        } else {
            e('body').removeClass('onscroll');
            e('#header').css('top', (0) + 'px');
            e('#page,#page-intro').css('paddingTop', (0) + 'px')
        }
    })
});;